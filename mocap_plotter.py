...
header_list = ["Frame", "Framerate", "Latency", "x", "y", "z", "roll", "pitch", "yaw","err"] #plot data layout
...
if show_square_ref:
	...
	#xyz data
	tx_P = np.concatenate( (np.full(500,0), np.linspace(0,1000, num=500), np.full(1000,1000), np.linspace(0,1000, num=500), np.full(1000,0)) )	
	tx_t = np.concatenate( (np.linspace(10,15, num=500), np.full(500,15), np.linspace(15,25, num=1000), np.full(500,25), np.linspace(25,35, num=1000)) )
	ty_P = np.concatenate( (np.full(1000,0), np.linspace(0,-1000, num=500), np.full(1000,-1000), np.linspace(0,-1000, num=500), np.full(500,0)) )
	ty_t = np.concatenate( (np.linspace(10,20, num=1000), np.full(500,20), np.linspace(20,30, num=1000), np.full(500,30), np.linspace(30,35, num=500)) )
